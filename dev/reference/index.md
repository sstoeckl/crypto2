...
- [`crypto_info()`](https://www.sebastianstoeckl.com/crypto2/dev/reference/crypto_info.md)
  : Retrieves info (urls, logo, description, tags, platform, date_added,
  notice, status,...) on CMC for given id
- [`crypto_list()`](https://www.sebastianstoeckl.com/crypto2/dev/reference/crypto_list.md)
  : Retrieves name, CMC id, symbol, slug, rank, an activity flag as well
  as activity dates on CMC for all coins
...
- [`exchange_info()`](https://www.sebastianstoeckl.com/crypto2/dev/reference/exchange_info.md)
  : Retrieves info
  (urls,logo,description,tags,platform,date_added,notice,status) on CMC
  for given exchange slug
...
- [`fiat_list()`](https://www.sebastianstoeckl.com/crypto2/dev/reference/fiat_list.md)
  : Retrieves list of all CMC supported fiat currencies available to
