...
#> 1 2021-01-01 23:59:59 bitco~     1 Bitco~ BTC    USD     2.90e+4 2.96e+4 2.88e+4
#> 2 2021-01-02 23:59:59 bitco~     1 Bitco~ BTC    USD     2.94e+4 3.32e+4 2.91e+4
#> 3 2021-01-01 23:59:59 litec~     2 Litec~ LTC    USD     1.25e+2 1.33e+2 1.23e+2
#> 4 2021-01-02 23:59:59 litec~     2 Litec~ LTC    USD     1.26e+2 1.40e+2 1.24e+2
#> 5 2021-01-01 23:59:59 namec~     3 Namec~ NMC    USD     4.39e-1 4.63e-1 4.32e-1
#> 6 2021-01-02 23:59:59 namec~     3 Namec~ NMC    USD     4.51e-1 5.10e-1 4.15e-1
...
#>    timestamp           slug      id name  symbol ref_cur    open    high     low
#>    <dttm>              <chr>  <int> <chr> <chr>  <chr>     <dbl>   <dbl>   <dbl>
#>  1 2021-01-01 23:59:43 bitco~     1 Bitc~ BTC    BTC     1   e+0 1.00e+0 9.98e-1
#>  2 2021-01-02 23:59:43 bitco~     1 Bitc~ BTC    BTC     1   e+0 1.00e+0 9.99e-1
#>  3 2021-01-01 23:59:06 bitco~     1 Bitc~ BTC    EUR     2.37e+4 2.43e+4 2.36e+4
#>  4 2021-01-02 23:59:06 bitco~     1 Bitc~ BTC    EUR     2.42e+4 2.73e+4 2.40e+4
#>  5 2021-01-01 23:59:43 litec~     2 Lite~ LTC    BTC     4.30e-3 4.56e-3 4.27e-3
#>  6 2021-01-02 23:59:43 litec~     2 Lite~ LTC    BTC     4.30e-3 4.24e-3 4.23e-3
#>  7 2021-01-01 23:59:06 litec~     2 Lite~ LTC    EUR     1.02e+2 1.09e+2 1.01e+2
#>  8 2021-01-02 23:59:06 litec~     2 Lite~ LTC    EUR     1.04e+2 1.16e+2 1.02e+2
#>  9 2021-01-01 23:59:43 namec~     3 Name~ NMC    BTC     1.51e-5 1.58e-5 1.50e-5
#> 10 2021-01-02 23:59:43 namec~     3 Name~ NMC    BTC     1.54e-5 1.57e-5 1.31e-5
#> 11 2021-01-01 23:59:06 namec~     3 Name~ NMC    EUR     3.60e-1 3.80e-1 3.54e-1
#> 12 2021-01-02 23:59:06 namec~     3 Name~ NMC    EUR     3.71e-1 4.21e-1 3.41e-1
#> # ... with 7 more variables: close <dbl>, volume <dbl>, market_cap <dbl>,
#> #   time_open <dttm>, time_close <dttm>, time_high <dttm>, time_low <dttm>
```
...
#>  1    16 Poloniex   poloniex           1 2018-04-26           2021-06-23        
#>  2    22 Bittrex    bittrex            1 2018-04-26           2021-06-23        
#>  3    24 Kraken     kraken             1 2018-04-26           2021-06-23        
#>  4    32 Bleutrade  bleutrade          1 2018-04-26           2021-06-23        
#>  5    34 Bittylici~ bittylici~         1 2018-04-26           2021-06-23        
#>  6    36 CEX.IO     cex-io             1 2018-04-26           2021-06-23        
#>  7    37 Bitfinex   bitfinex           1 2018-04-26           2021-06-23        
#>  8    42 HitBTC     hitbtc             1 2018-04-26           2021-06-23        
#>  9    50 EXMO       exmo               1 2018-04-26           2021-06-23        
#> 10    61 Okcoin     okcoin             1 2018-04-26           2021-06-23        
#> # ... with 369 more rows
```
