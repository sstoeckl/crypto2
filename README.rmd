...
> **Experimental:** A CoinGecko integration is currently in testing on branch
...
> CMC-column-compatible companions that pull from CoinGecko, **no API key
> required**. Please install and play around with it, and open an issue if
> anything breaks. Install with:
>
> ```r
...
> when delisted-coin retrieval is impossible. Build a survivorship-bias-free
> archive by snapshotting periodically (daily/weekly) from your own cronjob.
